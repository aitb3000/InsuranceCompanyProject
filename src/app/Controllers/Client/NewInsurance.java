...
//    {
//        txtFirstName.setText(Main.AppUser.GetCurrentAppUser().getFirstName());
//        txtLastName.setText(Main.AppUser.GetCurrentAppUser().getLastName());
...
//            lblNewInsuranceCheckLField.setVisible(false);
//
//            sqlConnection.getInstance().SendQueryExecute(String.format("INSERT INTO insurances VALUES ('%s','%d','%s','%s','%s','%s','%s','%s','%s')",
//                    txtId.getText(),
//                    cbInsurance.getSelectionModel().getSelectedIndex(),
//                    Insurance.getInsuranceStatus((byte) 1),
...
//        lblClientName.setText(Main.AppUser.GetCurrentAppUser().getUserName());
//        lblNewInsuranceCheckLField.setVisible(false);
//        GetInsuranceFromXML();
//        txtId.setText(Main.AppUser.GetId());
//        txtFirstName.setText(Main.AppUser.GetCurrentAppUser().getFirstName());
